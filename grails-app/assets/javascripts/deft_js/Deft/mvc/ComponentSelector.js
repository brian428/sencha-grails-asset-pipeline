...
Ext.define('Deft.mvc.ComponentSelector', {
  ...
  constructor: function(config) {
    var eventName, fn, listener, listenerList, options, scope, _i, _len, _ref;
    ...
    if (Ext.isObject(this.listeners)) {
      ...
      for (eventName in _ref) {
        listenerList = _ref[eventName];
        if (!Ext.isArray(listenerList)) {
          listenerList = [listenerList];
        }
        for (_i = 0, _len = listenerList.length; _i < _len; _i++) {
          listener = listenerList[_i];
          fn = listener;
          scope = this.scope;
          options = null;
  ...
  */
  ...
  addListener: function(eventName, fn, scope, options) {
    ...
    Deft.Logger.log("Adding '" + eventName + "' listener to '" + this.selector + "' with fn: " + fn + ".");
